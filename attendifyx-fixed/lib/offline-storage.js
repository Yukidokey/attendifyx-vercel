// IndexedDB is browser-only. All functions in this file are safe to import
// in server-side API routes — they simply return early / return defaults
// when not running in a browser (Vercel Node.js / Edge runtime).
