...
// Use placeholders at build time — real values must be set in Vercel env vars.
// Requests will fail at runtime if missing, not during build.
...
// Lazy-init admin client — only created at runtime when actually called
